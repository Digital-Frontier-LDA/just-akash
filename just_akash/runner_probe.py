...
def main(argv: list[str] | None = None) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="akash-probe-") as tmpdir:
        ...
        # recommends 0o644. That is exactly backwards for a DIRECTORY holding live
        # credentials: 0o700 is owner-only, while the suggested 0o644 is world-READABLE and
        # would hand any other user on the box the PAT this block exists to protect.
